git add README.md  
git commit -m "Add bootcamp README with module structure" # BU CS Foundations Bootcamp
...
## Programs
Each module folder contains the Java source files from that module’s activity. # bu-bootcamp
